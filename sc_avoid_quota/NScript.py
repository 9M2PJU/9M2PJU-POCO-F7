...
required_packages = ["requests", "ntplib", "pytz", "urllib3", "colorama"]
...
def get_initial_beijing_time():
    ...
    for server in ntp_servers:
        try:
            print(col_y + f"\nGetting current time in Beijing from {server}..." + Fore.RESET)
    ...
    print(f"Using system clock synchronized to Asia/Shanghai.")
